...
Gem::Specification.new do |spec|
  ...
  spec.add_runtime_dependency "aws-sdk-kms", ">=1.21.0", ">= 1.21.0"
  spec.add_runtime_dependency "aws-sdk-ssm", ">=1.47.0", ">= 1.47.0"
  ...
  spec.add_development_dependency "webmock", "~> 3.0", "~> 3.5.1"
end
